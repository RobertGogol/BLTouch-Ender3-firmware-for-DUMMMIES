...
Included within this repository binary file "firmware.bin" is all you need, this edited (thats how BLtouch is always activated and configured) firmware Marlin 2.0bugfix binary for those, who upgraded Ender 3 with:
